%Ex8_5 Edge detection: Prewitt operator
...
filtered_I1 = imfilter(I, h, 'replicate');
...
subplot(2, 3, 2), imshow(filtered_I1), title('Prewitt horizontal image', "fontsize", FS);
subplot(2, 3, 3), imshow(filtered_I2), title('Prewitt vertical image', "fontsize", FS);
